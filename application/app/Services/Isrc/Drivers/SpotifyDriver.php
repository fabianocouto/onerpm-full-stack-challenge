 ...
 * SpotifyDriver Class
 */
class SpotifyDriver implements DriverInterface
{
    /**
     * SpotifyClient
     *
     * @var App\Services\Isrc\Drivers\Clients\SpotifyClient
     */
    public $spotifyClient;

    /**
     * SpotifyDriver Class Constructor
     *
    ...
    public function syncIsrc(Isrc $isrc) : bool
    {
        try {
            ...
            $response = $this->spotifyClient->searchIsrc($isrc);
            ...
            Log::error('IsrcService:Spotify: ISRC sync error', [
                'error' => $th->getMessage(),
                'isrc' => $isrc->code,
            ]);
